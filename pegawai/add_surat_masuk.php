...
if(!in_array($ext,$ekstensi) ) {
	...
	if($ukuran < 1044070){		
		...
		mysqli_query($connect, "INSERT INTO tbl_suratmasuk VALUES(NULL, $nomor_surat, '$asal_surat', '$tanggal_terima', '$tanggal_surat', '$perihal','$keterangan', '$ditujukkan', '$file_suratmasuk')");
